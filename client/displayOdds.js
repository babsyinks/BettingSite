function main() {
  function setClick(divId) {
    ...
    div.addEventListener('click', function() {
      ...
      let arrVal = Array.from(children)
          ...
          arrVal[i].addEventListener('click', function() {
            ...
            if (!altColor) {
              ...
              if (arrVal[i].id === 'epl') {
                ...
                let arr_vals = ['MAIN', 'GG/NG', 'O/U 1.5', 'O/U 2.5', 'O/U 3.5', 'O/U 4.5', 'RED CARD', 'PENALTY', 'CORNER O/U 8.5', 'CORNER O/U 11.5', 'WIN EITHER', 'WIN BOTH', 'O/U 1.5 HOME', 'O/U 1.5 AWAY', 'O/U 0.5 HOME', 'O/U 0.5 AWAY']
  ...
  let ids = ['England', 'Spain', 'Germany', 'Italy']
